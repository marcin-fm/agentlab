...
class AgentlabTest < Minitest::Test
  ...
  def test_agent_browser_has_checked_blocked_cargo_source_closure
    ...
    assert_includes(spec, "BuildRequires:  chromium")
    ...
    assert_includes(spec, "AGENT_BROWSER_CHROMIUM_SMOKE_BEGIN")
    assert_includes(spec, "--executable-path /usr/bin/chromium-browser --json open about:blank")
