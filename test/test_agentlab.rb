...
class AgentlabTest < Minitest::Test
  ...
  def test_xberg_is_blocked_and_kreuzberg_is_not_wired_for_source_generation
    ...
    assert_includes(spec, "%autosetup -p1 -n xberg-%{version}")
    refute_match(/^%autosetup .*\s-N(?:\s|$)/, spec)
    ...
    assert_equal("ac80b58f273017594a7bef816568c73e6532db0e86003edd6d1046926c3a3c04", vendor_receipt.dig("vendor_tree", "sha256"))
    assert_equal([56_653, 10_401, 0, 1_205_044_301], vendor_receipt.fetch("vendor_tree").values_at("files", "directories", "symlinks", "bytes"))
  ...
  def test_agent_browser_has_checked_blocked_cargo_source_closure
    ...
    assert_includes(spec, "%global fedora_proof_sha256 ac566fd40dd6b9190bf596c92b76aa8dbf275d7712c4f848cdb58f223eb77028")
    ...
    assert_equal(10785021, package.data.dig("dependency_status", "cargo", "remote_proof_build"))
    ...
    assert_equal(10785021, proof.dig("copr", "build_id"))
    assert_equal(true, proof.dig("validation", "chromium"))
    assert_equal(false, proof.dig("validation", "current_binary_build_success"))
