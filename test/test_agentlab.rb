...
class AgentlabTest < Minitest::Test
  ...
  def test_headroom_mcp_and_jwt_current_static_contracts
    ...
    assert_equal("0.33.0-0.4", headroom.data.dig("build_validation", "release"))
  ...
  def test_xberg_is_blocked_and_kreuzberg_is_not_wired_for_source_generation
    ...
    assert_equal("21b6cf73308d8e09df04987fcfb7b706021a78ad3219d8edf5d122666a637803", package.data.dig("source_audit_receipt", "sha256"))
    ...
    assert_equal("1.0.3-0.3", receipt.fetch("current_package_version"))
