...
class AgentlabTest < Minitest::Test
  ...
  def test_xberg_is_blocked_and_kreuzberg_is_not_wired_for_source_generation
    ...
    assert_equal([604, 1_040, 436], closure.fetch("counts").values_at("selected_registry_identities", "vendor_registry_identities", "resolver_only_registry_identities"))
    ...
    assert_equal("e3418b1feee8a7824b243e91552e3f550066410e6028c4c5484757d340dc9672", vendor_receipt.dig("vendor_tree", "sha256"))
    assert_equal([51_400, 9_488, 0, 1_101_005_097], vendor_receipt.fetch("vendor_tree").values_at("files", "directories", "symlinks", "bytes"))
    license = JSON.parse(File.read(File.join(package.directory, contract.dig("source_evidence", "license_text_presence", "file"))))
    assert_equal({ "present" => 963, "absent" => 77 }, license.fetch("counts"))
