...
class AgentlabTest < Minitest::Test
  ...
  def test_xberg_is_blocked_and_kreuzberg_is_not_wired_for_source_generation
    ...
    assert_equal([604, 610, 629, 0, -2, 0], contract.values_at("selected_registry_identities", "normal_packages", "normal_build_dev_packages", "git_dependencies", "ort_download_delta", "resolver_only_additions"))
    ...
    assert_equal("5491d0a5c54ca07ff5109b27332dfef48a87d65e35ed84086f1c9f25de1bc614", vendor_receipt.dig("vendor_tree", "sha256"))
    assert_equal("c38a83d8229f92e8590f8f2d3e678a06dfb9906dab66bbf1a0bbd40db9a65a9f", vendor_receipt.dig("inputs", "closure_report_sha256"))
    assert_equal([29_905, 4_815, 0, 411_276_011], vendor_receipt.fetch("vendor_tree").values_at("files", "directories", "symlinks", "bytes"))
    license = JSON.parse(File.read(File.join(package.directory, contract.dig("source_evidence", "license_text_presence", "file"))))
    assert_equal({ "present" => 581, "absent" => 23 }, license.fetch("counts"))
