...
class AgentlabTest < Minitest::Test
  ...
  def test_xberg_is_blocked_and_kreuzberg_is_not_wired_for_source_generation
    ...
    assert_includes(spec, "Release:        0.12%{?dist}")
    ...
    assert_equal("aaeb86ec031280408d6b549d1f5893f2e1e42b3ba18ea1f8fb0ded099c764b10", contract.dig("source_evidence", "auditor", "sha256"))
