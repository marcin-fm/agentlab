...
Source22 is a deterministic 239-archive union of the checked x64 and arm64 npm closures: 41,222,363 bytes at SHA-256 `c8f251509523fe27a648e496df9d5a7ee564c07a8afc5d67c712489df2fee7b4`. The configured-SCM-equivalent `0.0.40` source-delivery proof regenerates both 255-input closures byte-identically, records their 258-input union, and verifies the 329,438,070-byte, 41-member source RPM at SHA-256 `3d82379c2ebee951df1c4f59daa4d87da19f87255550cdbe122213707fd2ed87`. Two network-isolated `%prep` runs reproduce the existing 236-entry npm cache and source staging, semantically reproduce the source-license inventory, and checksum-verify the selected-license receipts, preserving the 4,613-entry, 121,972,064-byte cache tree at SHA-256 `50e66a5b8361735b2598a6be5d7d78f973db05104cbdf9b9addb01e9a113d214`. `%prep` remains explicitly x64-only; Source31 is source-delivery evidence only and makes no arm64 `%prep`, build, payload, or COPR claim.
