...
Blocked import of the staged `napi-derive-backend` 5.1.1 package. Its private semver patch and retained ctor 0.6 compatibility patch are both registered in the current spec.
