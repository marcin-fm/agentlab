...
unchanged. Build `10740237` then succeeded on Fedora 43 and Fedora 44 for both
architectures. Release `0.5` corrects the target scope to include Rawhide after
the maintainer confirmed Kreuzberg will publish there too.
